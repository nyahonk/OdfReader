...
Java_com_nyahonk_odfreader_domain_CoreWrapper_parseNative(JNIEnv *env, jobject instance, jobject options)
{
    ...
    jclass resultClass = env->FindClass("com/nyahonk/odfreader/domain/model/CoreResult");
...
JNIEXPORT jobject JNICALL
Java_com_nyahonk_odfreader_domain_CoreWrapper_backtranslateNative(JNIEnv *env, jobject thiz,
                                                                  jobject options,
                                                                  jstring htmlDiff) {
    jboolean isCopy;
...
Java_com_nyahonk_odfreader_domain_CoreWrapper_closeNative(JNIEnv *env, jobject thiz, jobject options) {
    jclass optionsClass = env->GetObjectClass(options);
    jfieldID pointerField = env->GetFieldID(optionsClass, "nativePointer", "J");
